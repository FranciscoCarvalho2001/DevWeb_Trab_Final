...
namespace DevWeb_Trab_Final.Controllers
{
    public class DispositivosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Tipo,DataReg,Modelo,Foto,ClienteFK")] Dispositivos dispositivos)
        {
            ...
            ViewData["ClienteFK"] = new SelectList(_context.Clientes, "Id", "Nome", dispositivos.ClienteFK);
            return View(dispositivos);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Tipo,DataReg,Modelo,Foto,ClienteFK")] Dispositivos dispositivos)
        {
        ...
        {
          return (_context.Dispositivos?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
